...
public class TestEighteenActivity extends Activity {
    ...
    public void categoryContent() {
        try {
            Logger.t("categoryContent").d(spider.categoryContent("chinese_list/all", "1", true, new HashMap<>()));
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
    ...
    public void detailContent() {
        try {
            Logger.t("detailContent").d(spider.detailContent(Arrays.asList("chinese_content/49105/SNIS-815.html")));
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
